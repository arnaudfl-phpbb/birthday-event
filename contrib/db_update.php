...
//
$sql = array();
$sql[] = 'ALTER TABLE ' . $table_prefix . 'users ADD user_birthday VARCHAR(10) NOT NULL DEFAULT \'\'';
$sql[] = 'ALTER TABLE ' . $table_prefix . 'users ADD user_zodiac TINYINT(2) NOT NULL DEFAULT 0';
